                                ...
                                <table class="table text-nowrap text-md-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="g-2">
                                                    <a href="{{ route('operation.export.show', $data->id) }}" class="btn text-purple btn-sm"
                                                    ...
                                                    <a href="{{ route('operation.export.edit', $data->id) }}" class="btn text-warning btn-sm"
                                                            data-bs-toggle="tooltip"
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="formCreateProgress" style="display: none" action="{{ route('operation.export.store-progress') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 form-select"
                                            data-placeholder="Choose one" name="transportation_create">
        ...
        $(document).ready(function() {
                    ...
                    success: function(response) {
                        ...
                        let content = `<div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <div class="g-2">
                                            <form action="{{ route('operation.export.delete-progress', ':id_progress') }}" method="POST" class="d-inline" onclick="return confirm('Are you sure wantsss to delete this item');">
                                                @csrf
                                                @method('delete')
            ...
            $('body').on('click', '#btn-edit-progress', function() {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {'id':id},
                    url: '{{ route('operation.export.edit-progress') }}',
                    success: function(response) {
                        ...
                        let content = `
                        <form action="{{ route('operation.export.update-progress') }}" method="POST" enctype="multipart/form-data">
                            @csrf
            ...
            $('select[name="transportation_create"]').change(function () {
                if (this.value == '1') {
                    $("#radio_buttons").html("");
                    var radioBtn = $(`<label class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input"
