                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4" id="phone_number" type="number" disabled value="{{ $marketingImport->contact->phone_number }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Company Address</label>
                                            <input class="form-control mb-4" id="company_address" type="text" disabled value="{{ $marketingImport->contact->address }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Company Name</label>
                                            <input class="form-control mb-4" id="company_name" type="text" disabled value="{{ $marketingImport->contact->company_name }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Payment Term</label>
                                            <input class="form-control mb-4" id="payment_term" type="text" disabled value="{{ $marketingImport->contact->term_of_payment }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Customer ID</label>
                                            <input class="form-control mb-4" id="get_customer_id" type="text" disabled value="{{ $marketingImport->contact->customer_id }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4" id="origin" type="text" disabled value="{{ $marketingImport->origin }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-label">Destination</label>
                                            <input class="form-control mb-4" id="destination" type="text" disabled value="{{ $marketingImport->destination }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4" id="shipper" type="text" disabled value="{{ $marketingImport->shipper }}"> 
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Consignee</label>
                                            <input class="form-control mb-4" id="consignee" type="text" disabled value="{{ $marketingImport->consignee }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4" name="total_weight" type="text" disabled value="{{ $marketingImport->total_weight }}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="form-label">Total Volume</label>
                                            <input class="form-control mb-4" name="total_volume" type="text" disabled value="{{ $marketingImport->total_volume }}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('marketing.import.update-sales') }}" method="POST">
                    @csrf
                    <input type="hidden" name="quotation_id" value="{{ $quotation->id }}">
                    <div class="row">
                        <div class="col-lg-12">
