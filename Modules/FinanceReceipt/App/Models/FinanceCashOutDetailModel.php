...
use Modules\FinanceReceipt\Database\factories\FinanceCashOutDetailModelFactory;

class FinanceCashOutDetailModel extends Model
{
    use HasFactory, HasRoles, SoftDeletes;
    
    protected $table = 'finance_cash_out_detail';
    protected $guarded = [];

    public function belong_head()
    {
        return $this->belongsTo(FinanceCashOutHeadModel::class, 'head_id', 'id');
    }
