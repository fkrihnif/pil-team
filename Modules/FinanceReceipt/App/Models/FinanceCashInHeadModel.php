...
use Modules\FinanceReceipt\Database\factories\FinanceCashInHeadModelFactory;

class FinanceCashInHeadModel extends Model
{
    use HasFactory, HasRoles, SoftDeletes;
    
    protected $table = 'finance_cash_in_head';
    protected $guarded = [];
    ...
    {
        return $this->hasMany(FinanceCashInDetailModel::class, 'head_id');
    }
}