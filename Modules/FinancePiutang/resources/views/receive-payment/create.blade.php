                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="no_cipl" id="no_cipl" value="{{ old('no_cipl') }}" placeholder="Auto Link"  >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tbody id="table-body">
                                    ...
                                    <tr class="group-form" data-group="${groupChar}">
                                        ...
                                        <td width="25%">
                                            <select class="form-control select2 form-select"
                                                data-placeholder="Link To Invoice" name="customer_id" id="customer_id" required>
                                                <option label="Choose one" selected disabled></option>
                                            </select>
                                            <label for="" class="form-label">Remark</label>
                                            <input type="text" class="form-control remark-input mt-2" name="remark_${groupChar}[]" placeholder="Text.." />
                                        </td>
                                        <td width="15%">
                                            <input type="text" class="form-control border-left-0 pl-2 total-input" name="total_${groupChar}[]" data-group="${groupChar}" autocomplete="off" disabled />                                
                                        </td>
                                        <td width="15%">
                                            <input type="text" class="form-control remark-input" name="remark_${groupChar}[]" disabled />
                                        </td>
                                        <td width="20%">
                                            <input type="text" class="form-control remark-input" name="remark_${groupChar}[]" disabled />
                                        </td>
                                        <td width="15%">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <select class="form-control select2 form-select" data-placeholder="Choose one" name="customer_id" id="customer_id" required>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="" class="form-label">Catatan Transaksi</label>
                                        <textarea name="" id="" cols="30" rows="5" placeholder="Tulis catatan transaksi di sini ( maks 1000 karakter )" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <table width="50%" class="table mt-5">
                                        <tr>
                                            ...
                                            <td><a data-bs-effect="effect-scale" data-bs-toggle="modal" href="#modal-akun"><i class="fa fa-angle-down"></i></a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="d-flex justify-content-between">
...
{{-- modal akun --}}
<div class="modal fade" id="modal-akun" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Kode Akun</h5>
                <button class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
            </div>
