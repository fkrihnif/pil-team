                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="no_cipl" id="no_cipl" value="{{ old('no_cipl') }}" placeholder="link to sales order">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="no_cipl" id="no_cipl" value="{{ old('no_cipl') }}" placeholder="">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <table class="table">
                                ...
                                <tbody id="table-body">
                                    ...
                                    <tr class="group-form" data-group="${groupChar}">
                                        ...
                                        <td></td>
                                        <td width="40%">
                                            <input type="text" class="form-control description-input" name="description_${groupChar}[]" placeholder="Desc" />
                                            <label for="" class="form-label">Remark</label>
                                            <input type="text" class="form-control remark-input mt-2" name="remark_${groupChar}[]" placeholder="Text.." />
                                            
                                        </td>
                                        <td width="15%">
                                            <input type="text" class="form-control border-left-0 pl-2 total-input" name="total_${groupChar}[]" data-group="${groupChar}" autocomplete="off" />
                                        ...
                                        <td width="10%">
                                            ...
                                            <select class="form-control select2 form-select" data-placeholder="%" name="customer_id" id="customer_id" required>
